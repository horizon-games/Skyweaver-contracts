...
export interface ConquestEntriesFactoryInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "assignOwnership" | "conquestEntryID" | "getOwnerTier" | "onERC1155BatchReceived" | "onERC1155Received" | "silverRangeMax" | "silverRangeMin" | "skyweaverAssets" | "supportsInterface" | "wDaiID" | "withdraw"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "withdraw", values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>]): string;
...
export interface ConquestEntriesFactory extends BaseContract {
    ...
    functions: {
        ...
        withdraw(_recipient: PromiseOrValue<string>, _data: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    assignOwnership(_address: PromiseOrValue<string>, _tier: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    callStatic: {
        ...
        supportsInterface(interfaceID: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<boolean>;
        wDaiID(overrides?: CallOverrides): Promise<BigNumber>;
        withdraw(_recipient: PromiseOrValue<string>, _data: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
