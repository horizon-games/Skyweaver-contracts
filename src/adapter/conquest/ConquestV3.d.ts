...
export interface ConquestV3Interface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "assignOwnership" | "conquestEntryID" | "conquestsEntered" | "exitConquest" | "getOwnerTier" | "goldCardFactory" | "isActiveConquest" | "mintGold" | "oldConquest" | "onERC1155BatchReceived" | "onERC1155Received" | "pendingEntered" | "silverCardFactory" | "skyweaverAssets" | "supportsInterface"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "mintGold", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "pendingEntered", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    ...
    decodeFunctionResult(functionFragment: "pendingEntered", data: BytesLike): Result;
...
export interface ConquestV3 extends BaseContract {
    ...
    functions: {
        ...
        mintGold(_user: PromiseOrValue<string>, _conquestNonce: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        pendingEntered(_user: PromiseOrValue<string>, _conquestNonce: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    callStatic: {
        ...
        goldCardFactory(overrides?: CallOverrides): Promise<string>;
        isActiveConquest(_user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        mintGold(_user: PromiseOrValue<string>, _conquestNonce: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        oldConquest(overrides?: CallOverrides): Promise<string>;
    ...
    filters: {
        "ConquestEntered(address,uint256)"(user?: PromiseOrValue<string> | null, nConquests?: null): ConquestEnteredEventFilter;
        ConquestEntered(user?: PromiseOrValue<string> | null, nConquests?: null): ConquestEnteredEventFilter;
    ...
    populateTransaction: {
        ...
        pendingEntered(_user: PromiseOrValue<string>, _conquestNonce: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
